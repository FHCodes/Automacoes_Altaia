...
__doc__ = \
	'''
	MAHINDRA CSV files parser manager
'''
...
MODULES = importlib.import_module("shelf.collectorprocess.operators.Readers.MAHINDRA.CSV.MODULES")
...
class Operator(BaseOperator):
	...
	def process(self, familyObj=FamilyObject(), baseObject={}):
		...
		logger.debug("Entering CSV files parser manager")
