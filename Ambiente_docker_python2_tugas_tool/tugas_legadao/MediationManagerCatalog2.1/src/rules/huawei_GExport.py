	...
	for ossId in unitDict.keys():
		...
		for tableId in unitObj.tables.keys():
			...
			if '2G' in unitObj.tech:
				createLevel(unitObj, tableObj, ['BSC_NAME'], ['BTS_NAME'], ['CELL_NAME'], ['BSC_NAME'])
			if '3G' in unitObj.tech:
				createLevel(unitObj, tableObj, ['RNC_NAME'], ['NODEB_NAME'], ['CELL_NAME'], ['RNC_NAME'])
			if '4G' in unitObj.tech:
				createLevel(unitObj, tableObj, [], ['ENODEB_NAME'], ['CELL_NAME'], ['ENODEB_NAME'])
			if '5G' in unitObj.tech:
				createLevel(unitObj, tableObj, [], ['GNODEB_NAME'], ['CELL_NAME'], ['GNODEB_NAME'])
